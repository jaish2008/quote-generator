...
<title>QuoteLab — Advanced Quote Generator</title>
  ...
  <header class="top">
    <div class="brand">
      ...
      <div>
        ...
        <div class="small-muted">Daily inspiration & moods — offline-ready</div>
      </div>
    </div>
   ...
   <div>
      <div class="card" aria-live="polite">
        ...
        <div class="card-actions">
          ...
          <button id="favBtn" class="btn small">♡ Save</button>
    ...
    <div class="side">
      ...
      <div class="panel">
        ...
        <div class="fav-list" id="favList">
          <div class="small-muted">No favourites yet — save a quote to see it here.</div>
        </div>
      </div>
...
const quotes = [
  ...
  { text:"Your limitation—it's only your imagination.", author:"k.jasons", mood:"motivation" },
  ...
  { text:"Success doesn’t just find you. You find it.", author:"david styin", mood:"motivation" },
  ...
  { text:"Relax. Nothing is under control — and that’s okay.", author:"syndy sten", mood:"stress" },
...
async function showQuote(qObj, {playBell=true, typewriter=true} = {}){
  ...
  quoteAuthor.textContent = '— ' + (qObj.author || 'Unknown');
  animateIn();
}
...
function addFav(){
  ...
  setTimeout(()=> favBtn.textContent = '♡ Save', 900);
}
function clearFavs(){
...
function renderFavs(){
  ...
  favListEl.innerHTML = '';
  if(list.length === 0){
    favListEl.innerHTML = '<div class="small-muted">No favourites yet — save a quote to see it here.</div>';
    return;
  }
  for(const it of list){
...
(function init(){
  ...
  else showQuote({ text:'Click New Quote to start — or pick a mood.' , author:'' }, {playBell:false, typewriter:false});
})();
